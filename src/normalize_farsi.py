...
with open(input_file, 'r') as fh:
    for line in fh:
        ...
        for char in char_array:
            # FIRST!!! convert from presentation form to base form (just in case g.t. was in presentaiton form for some reason)
            ...
            if char == "u0640":
                ...
                nop += 1
#            elif char == "u200c":
#                # Treat ZWNJ like space
#                new_char_array.append("u0020")
            elif char == "u06a9":
                # u06a9 (arabic keheh) -> u0643 (arabic kaf)
                new_char_array.append("u0643")
            elif char == "u06cc":
                # 06cc (Farsi Yeh) -> 64a (Arabic Yeh)
                new_char_array.append("u064a")
            elif char == "u200f" or char == "u200e":
                # remove RTL and LTR marks
                nop += 1
            elif char == "ufdfc":
                # Transform ligature for RIAL sign -> seq of chars for rial sign
                new_char_array.append("u0631")
                new_char_array.append("u06cc")
                new_char_array.append("u0627")
                new_char_array.append("u0644")
            elif char == "u06f0":
                # Extended (farsi) arabic-indic digit -> regular arabic-indic digit
                new_char_array.append("u0660")
            elif char == "u06f1":
                # Extended (farsi) arabic-indic digit -> regular arabic-indic digit
                new_char_array.append("u0661")
            elif char == "u06f2":
                # Extended (farsi) arabic-indic digit -> regular arabic-indic digit
                new_char_array.append("u0662")
            elif char == "u06f3":
                # Extended (farsi) arabic-indic digit -> regular arabic-indic digit
                new_char_array.append("u0663")
            elif char == "u06f4":
                # Extended (farsi) arabic-indic digit -> regular arabic-indic digit
                new_char_array.append("u0664")
            elif char == "u06f5":
                # Extended (farsi) arabic-indic digit -> regular arabic-indic digit
                new_char_array.append("u0665")
            elif char == "u06f6":
                # Extended (farsi) arabic-indic digit -> regular arabic-indic digit
                new_char_array.append("u0666")
            elif char == "u06f7":
                # Extended (farsi) arabic-indic digit -> regular arabic-indic digit
                new_char_array.append("u0667")
            elif char == "u06f8":
                # Extended (farsi) arabic-indic digit -> regular arabic-indic digit
                new_char_array.append("u0668")
            elif char == "u06f9":
                # Extended (farsi) arabic-indic digit -> regular arabic-indic digit
                new_char_array.append("u0669")
            ...
            elif char == "u2013" or char == "u2014" or char == "u2015" or char == "u2012" or char == "u2011" or char == "u2010":
                # Change Arabic dash to Reular hyphen
                new_char_array.append("u002d")
            elif char == "uff09":
                # Change Full width right-paren to regular paren
                new_char_array.append("u0029")
            elif char == "uff08":
                # Change Full width left-paren to regular paren
                new_char_array.append("u0028")
            else:
